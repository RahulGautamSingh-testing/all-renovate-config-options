This repo has json files which contain all the config options and all accepted values which can be present inside the renovate bot's repo config. Options haven't been migrated btw.
